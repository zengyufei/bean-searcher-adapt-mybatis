...
import com.xunmo.bs.config.bs.op.MySqlCond;
...
public class MyBuilder<B extends MyBuilder<B>> {
    ...
    public MyBuilder(Map<String, Object> map) {
        this.map = map;
    }
    ...
    public B sql(String sqlCond) {
        return fieldOp(new MySqlCond(sqlCond));
    }
    ...
    public B sql(String sqlCond, Object... args) {
        return fieldOp(new MySqlCond(sqlCond, args));
    }
